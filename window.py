...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.clusterSampleSize)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.clusterOnData)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.clusterMinClusterSize)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.clusterMinSamples)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.clusterPushButton)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.evaluateClusteringCheckBox)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.FieldRole, self.highlightClusterPushButton)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.ItemRole.FieldRole, self.joinClusterPushButton)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.ItemRole.FieldRole, self.splitCluster)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.scatterColorOption)
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.scatterScaleOption)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.formLayout_2.setItem(3, QtWidgets.QFormLayout.ItemRole.LabelRole, spacerItem1)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.ternColorOption)
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.ternScaleOption)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.formLayout_2.setItem(7, QtWidgets.QFormLayout.ItemRole.LabelRole, spacerItem2)
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.giniCoeff)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_12)
        ...
        self.clusterInformationTable.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.DoubleClicked)
